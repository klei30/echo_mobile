      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: const [
              _WorkflowChip(icon: Icons.wb_sunny_outlined, label: 'Today'),
              _WorkflowChip(icon: Icons.visibility_outlined, label: 'Passport'),
              _WorkflowChip(icon: Icons.psychology_alt_outlined, label: 'Decision Room'),
              _WorkflowChip(icon: Icons.model_training_rounded, label: 'Improve Echo'),
              _WorkflowChip(icon: Icons.inventory_2_outlined, label: 'Proof'),
              _WorkflowChip(icon: Icons.emoji_events_outlined, label: 'Opportunities'),
              _WorkflowChip(icon: Icons.grain_rounded, label: 'Memory'),
              _WorkflowChip(icon: Icons.bolt_outlined, label: 'Outcome Capture'),
            ],
          ),
        ],
      ),
