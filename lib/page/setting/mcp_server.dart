...
class _McpServerState extends State<McpServer> {
  ...
  String _selectedTab = 'installed'; // ä½¿ç”¨å›ºå®šçš„è‹±æ–‡æ ‡è¯†ç¬¦
            ...
            return Padding(
              ...
              child: Column(
                children: [
                  ...
                  // æ ‡ç­¾é€‰æ‹©å’Œæ“ä½œæŒ‰é’®
                  LayoutBuilder(
                    builder: (context, constraints) {
                      // åœ¨å®½å±è®¾å¤‡ä¸Šä½¿ç”¨Rowå®žçŽ°ä¸¤è¾¹å¯¹é½
                      if (constraints.maxWidth > 500) {
                        // è®¾å®šä¸€ä¸ªåˆç†çš„å®½åº¦é˜ˆå€¼
                        return Row(
                          children: [
                            Wrap(
                              spacing: 12,
                        ...
                        // åœ¨çª„å±è®¾å¤‡ä¸Šç»§ç»­ä½¿ç”¨Wrapè‡ªåŠ¨æ¢è¡Œ
                        return Column(
  ...
  Widget _buildEchoToolsHeader(BuildContext context) {
    final rows = [
      _ActionRow(
        ...
        body: 'Connect trusted apps, data sources, and developer actions Echo can call when you allow it.',
        color: EchoColors.primaryAi,
      ),
      _ActionRow(
        icon: Icons.shield_rounded,
        title: 'Keep your data private',
        body: 'Local connections run on your machine or private network, so sensitive work stays under your control.',
        color: EchoColors.practice,
      ),
      _ActionRow(
        icon: Icons.terminal_rounded,
        title: 'Add expert tools',
        body: 'Use this advanced manager only when you need custom commands, URLs, or developer integrations.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            child: Row(
              children: [
                Container(
                  width: 32,
                  height: 32,
                  decoration: BoxDecoration(color: EchoColors.primaryAi.withValues(alpha: 0.14), borderRadius: BorderRadius.circular(9)),
                  child: Icon(Icons.extension_rounded, size: 16, color: EchoColors.primaryAi),
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('Technical connections for power users', style: GoogleFonts.plusJakartaSans(fontSize: 11, color: EchoColors.textMuted)),
                    ],
                  ),
                ),
              ],
          ...
          Divider(height: 1, color: EchoColors.borderSubtle),
          ...rows,
        ],
      ),
    );
                ...
                FutureBuilder<Map<String, dynamic>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return _buildActionButton(
                      icon: isAuthenticated ? (needsRefresh ? CupertinoIcons.refresh : CupertinoIcons.checkmark_shield) : CupertinoIcons.lock,
                      tooltip: isAuthenticated ? (needsRefresh ? 'Refresh OAuth Token' : 'OAuth Authenticated') : 'Authenticate with OAuth',
                      onPressed: () async {
                        setState(() {
      ...
      final confirmed = await showDialog<bool>(
        ...
        builder: (BuildContext dialogContext) {
          return AlertDialog(
            ...
            title: Text(
              'Advanced connection - ${serverName.isEmpty ? l10n.addProvider : serverName}',
                    ...
                    if (_isCheckingOAuth) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(color: Theme.of(context).colorScheme.primary.withAlpha(100), width: 1),
                        ),
                        child: Row(
                          children: [
            ...
            actions: [
              ...
              TextButton(
                onPressed: () async {
                  ...
                  // æ”¹è¿›çš„å‚æ•°è§£æžé€»è¾‘ï¼Œæ”¯æŒå¼•å·åŒ…å›´çš„å‚æ•°
                  List<String> args = [];
                  if (argsString.isNotEmpty) {
                    // åŒ¹é…å•å¼•å·ã€åŒå¼•å·åŒ…å›´çš„å‚æ•°ï¼Œæˆ–è€…ä¸åŒ…å«ç©ºæ ¼çš„å‚æ•°
...
class _ActionRow extends StatelessWidget {
  ...
  const _ActionRow({required this.icon, required this.title, required this.body, required this.color, this.isLast = false});
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(body, style: GoogleFonts.plusJakartaSans(fontSize: 11, height: 1.4, color: EchoColors.textMuted)),
              ],
            ),
          ),
        ],
