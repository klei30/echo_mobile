...
class InputAreaState extends State<InputArea> {
  ...
  Future<void> _loadVoicePreference() async {
    ...
    if (!mounted) return;
    setState(() => _voiceEnabled = prefs.getBool('echo_setting_voice') ?? true);
  }
  ...
  // â”€â”€ Echo mobile input bar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
                ...
                children: [
                  Expanded(
                    child: TextField(
                      ...
                      style: TextStyle(fontSize: 14, color: EchoColors.textPrimary),
                      decoration: InputDecoration(
                        hintText: 'Keep talking...',
                        hintStyle: TextStyle(fontSize: 14, color: EchoColors.textGhost),
                        border: InputBorder.none,
                        isDense: true,
                        contentPadding: EdgeInsets.zero,
                        fillColor: Colors.transparent,
                      ),
                      cursorColor: EchoColors.primaryAi,
                    ),
                  ),
                  const SizedBox(width: 8),
                  // Mic button
                  if (!widget.disabled && _voiceEnabled)
                              ...
                              : () async {
                                  if (vs == VoiceState.idle) {
                                    ...
                                    await Navigator.of(ctx).push(
                                      PageRouteBuilder(
                                        pageBuilder: (context, animation, secondaryAnimation) => const VoiceSessionScreen(),
                          ...
                          child: Padding(
                            ...
                            child: isConnecting
                                ? SizedBox(
                                    width: 17,
                                    height: 17,
                                    child: CircularProgressIndicator(strokeWidth: 2, valueColor: AlwaysStoppedAnimation(EchoColors.textGhost)),
                                  )
                                : Icon(
                                    isActive ? Icons.mic_rounded : Icons.mic_none_rounded,
                                    size: 17,
                                    color: isActive ? EchoColors.primaryAi : EchoColors.textGhost,
                                  ),
                          ),
                        );
                      },
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: widget.disabled
                    ? null
                    : LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [EchoColors.primaryAi, EchoColors.practice]),
                color: widget.disabled ? EchoColors.deepSurface : null,
              ),
              child: Icon(
                widget.disabled ? Icons.stop_rounded : Icons.arrow_forward_rounded,
                size: 15,
                color: widget.disabled ? EchoColors.textMuted : Colors.white,
              ),
            ),
          ),
        ],
...
// â”€â”€ Voice status banner â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
      ...
      builder: (context, snap) {
        ...
        final (label, icon, color) = switch (state) {
          ...
          VoiceState.listening => (
            _lastTranscript.isNotEmpty ? '"$_lastTranscript"' : 'Voice capture active...',
