      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
              ...
              child: Row(
                children: [
                  Container(
                    width: 7,
                    height: 7,
                    decoration: BoxDecoration(shape: BoxShape.circle, color: hasTunnel ? const Color(0xFF4CAF50) : EchoColors.amber),
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          ...
                          style: GoogleFonts.plusJakartaSans(fontSize: 12, fontWeight: FontWeight.w700, color: EchoColors.textMuted),
                        ),
                        Text(
                          current,
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: _urlCtrl.text.isNotEmpty
                      ? IconButton(
                          icon: Icon(Icons.clear_rounded, size: 16, color: EchoColors.textGhost),
                          onPressed: _clear,
                        )
                      : null,
                ),
            ...
            // Android emulator shortcut â€” 10.0.2.2 routes to host machine
            if (!kIsWeb && defaultTargetPlatform == TargetPlatform.android) ...[
              ...
              GestureDetector(
                ...
                child: Row(
                  children: [
                    Icon(Icons.computer_rounded, size: 13, color: EchoColors.amber),
                ...
                Expanded(
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: _testing
                          ? Center(
                              child: SizedBox(width: 16, height: 16, child: CircularProgressIndicator(strokeWidth: 1.5, color: EchoColors.amber)),
                            )
                          : Row(
                ...
                Expanded(
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: _saving
                          ? Center(
                              child: SizedBox(width: 16, height: 16, child: CircularProgressIndicator(strokeWidth: 1.5, color: EchoColors.bg)),
                            )
                          : Text(
                              'Save',
                              textAlign: TextAlign.center,
                              style: GoogleFonts.plusJakartaSans(fontSize: 13, fontWeight: FontWeight.w700, color: EchoColors.bg),
                            ),
                    ),
                  ),
                ),
            ...
            if (_testError != null) ...[
              const SizedBox(height: 8),
              Text(_testError!, style: GoogleFonts.plusJakartaSans(fontSize: 11.5, color: Colors.redAccent.withValues(alpha: 0.8))),
            ],
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.help_outline_rounded, size: 16, color: EchoColors.textGhost),
                    const SizedBox(width: 10),
                    Expanded(
                      child: Text(
                        'Manual setup notes',
                        style: GoogleFonts.plusJakartaSans(fontSize: 13, fontWeight: FontWeight.w600, color: EchoColors.textMuted),
                      ),
                    ),
                    Icon(_showGuide ? Icons.expand_less_rounded : Icons.expand_more_rounded, size: 18, color: EchoColors.textGhost),
                  ],
                ),
              ),
            ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _guideStep('2', 'Start the tunnel', 'Open a terminal on your PC and run:\ncloudflared tunnel --url http://localhost:8002'),
                    _guideStep('3', 'Copy the URL', 'cloudflared prints a URL like:\nhttps://abc-def-ghi.trycloudflare.com\n\nCopy that URL.'),
                    _guideStep(
                      '4',
                      'Paste it above',
                    ...
                    Container(
                      ...
                      child: Text(
                        ...
                        style: GoogleFonts.plusJakartaSans(fontSize: 11.5, color: EchoColors.amberText, height: 1.5),
                      ),
                    ),
                  ],
                ),
        ...
        children: [
          Container(
            ...
            child: Center(
              child: Text(
                num,
                style: GoogleFonts.plusJakartaSans(fontSize: 10, fontWeight: FontWeight.w800, color: EchoColors.amberText),
              ),
            ),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(body, style: GoogleFonts.plusJakartaSans(fontSize: 11.5, color: EchoColors.textGhost, height: 1.5)),
              ],
            ),
          ),
        ],
