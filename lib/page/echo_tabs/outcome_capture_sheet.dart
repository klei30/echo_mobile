...
class _OutcomeCaptureSheetState extends State<OutcomeCaptureSheet> {
  ...
  Future<void> _save() async {
    ...
    final note = jsonEncode({'context': widget.contextNote, 'energy': _energy, 'confidence': _confidence.round(), 'note': userNote});
    final ok = await EchoApiClient().recordOutcome(
        ...
        child: SafeArea(
          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  const Icon(Icons.fact_check_outlined, color: EchoColors.amber, size: 18),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(14),
                    borderSide: const BorderSide(color: EchoColors.amber),
                  ),
                ),
              ),
              ...
              SizedBox(
                ...
                child: FilledButton.icon(
                  ...
                  label: Text(_saving ? 'Saving...' : (widget.createProof ? 'Save proof' : 'Save as signal')),
