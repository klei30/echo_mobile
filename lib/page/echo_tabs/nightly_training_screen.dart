...
// â”€â”€â”€ Gyroscope Orb â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Step Arc â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class _StepArcPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final tp = TextPainter(
      text: TextSpan(
        text: '$step/$total',
        style: TextStyle(fontSize: 9.5, color: EchoColors.amberText, fontFamily: 'PlusJakartaSans', fontWeight: FontWeight.w600),
      ),
        ...
        child: Row(
          ...
          children: [
            Padding(
              ...
              child: widget.done
                  ? Icon(Icons.check_rounded, size: 11, color: EchoColors.amber)
                  : Container(
                      width: 5,
                      height: 5,
...
// â”€â”€â”€ Dot Loader â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class _NightlyTrainingScreenState extends State<NightlyTrainingScreen> {
  ...
  static const _logLines = [
    'Reading saved moments...',
    'Finding useful patterns...',
    'Preparing recent outcomes...',
    'Practicing better responses...',
    'Saving the best lessons...',
    'Refreshing Echo...',
    'Restarting your personal model...',
    'Loading your updated guidance...',
    'Checking that it still sounds like Echo...',
  ];
  ...
  Future<void> _startTraining() async {
    ...
    if (status == 'not_enough_data') {
      final required = (result['required'] as num?)?.toInt() ?? 20;
      final pairs = (result['pairs'] as num?)?.toInt() ?? 0;
      final message = pairs >= required
          ? 'Enough moments are saved. Start Home Brain, then update Echo.'
          : 'Need ${required - pairs} more useful moments before Echo can update.';
      if (mounted) {
    ...
    if (status == 'runtime_unavailable') {
      if (mounted) {
        final reason = result['blocked_reason'] as String? ?? 'Home Brain is not ready.';
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            backgroundColor: EchoColors.bgCard,
            behavior: SnackBarBehavior.floating,
            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
            content: Text(
              '$reason Start Home Brain, then try again.',
  ...
  void _startLogAnimation() {
    ...
    final loopFrom = _logLines.indexOf('Loading your updated guidance...');
  ...
  // â”€â”€â”€ IDLE STATE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildHeroSection(totalPairs, lastTrained, completedRuns),

          const SizedBox(height: 32),

          // â”€â”€ Train Now CTA â”€â”€
          _buildTrainButton(),
          ...
          if (topics.isNotEmpty) ...[
            _buildCard(
              ...
              child: Column(
                children: [
                  Text(
                    'Topics Echo has the most evidence for',
  ...
  Widget _buildHeroSection(int totalPairs, String? lastTrained, List<Map<String, dynamic>> completedRuns) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Container(
                ...
                height: 42,
                decoration: BoxDecoration(
                  color: EchoColors.primaryAi.withValues(alpha: 0.10),
                  borderRadius: BorderRadius.circular(13),
                  border: Border.all(color: EchoColors.primaryAi.withValues(alpha: 0.20)),
                ),
                child: Icon(Icons.auto_awesome_rounded, size: 20, color: EchoColors.primaryAi),
              ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Use saved moments and feedback to make your personal model more useful.',
          ...
          Wrap(
            ...
            runSpacing: 8,
            children: [
              _pill(totalPairs > 0 ? '$totalPairs saved moments' : 'No saved moments yet', icon: Icons.chat_bubble_outline_rounded),
              _pill('${completedRuns.length} model updates', icon: Icons.memory_rounded),
              if (lastTrained != null) _pill(_formatDate(lastTrained), icon: Icons.access_time_rounded, color: EchoColors.primaryAi),
            ],
          ),
        ],
      ),
  ...
  // â”€â”€â”€ Dashboard Components â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  Widget _buildBattleSummaryCard() {
    ...
    return _buildCard(
      ...
      child: Column(
        ...
        children: [
          Text(
            leading == null ? 'Run Practice Versions to see which kind of help fits you best.' : '$leading is the guidance style helping most often.',
            style: GoogleFonts.lora(fontSize: 14, height: 1.5, color: EchoColors.textSecondary, fontStyle: FontStyle.italic),
          ),
          const SizedBox(height: 10),
          Text(
            'Home Brain can improve Echo from recent outcomes. This Device saves offline lessons and syncs them later.',
          ...
          const SizedBox(height: 20),
          _buildProgressRow('Moments ready', untrained, required, EchoColors.amber),
          const SizedBox(height: 12),
          _buildProgressRow('Lessons ready', dpoReady, dpoRequired, const Color(0xFF8A92D8)),
          const SizedBox(height: 18),
          Wrap(
            spacing: 8,
            runSpacing: 8,
            children: [
              _pill('$battles practice runs', icon: Icons.compare_arrows_rounded),
              _pill('$prefs helpful choices', icon: Icons.thumbs_up_down_rounded),
            ],
          ),
        ],
      ),
  ...
  Widget _buildEvolutionRoadmap(List<Map<String, dynamic>> completedRuns) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            Icon(Icons.route_rounded, size: 16, color: EchoColors.amber),
            const SizedBox(width: 8),
            Expanded(
              child: Text(
                'EVOLUTION ROADMAP',
  ...
  Widget _buildProgressRow(String label, int current, int required, Color color) {
    ...
    final frac = (current / safeRequired).clamp(0.0, 1.0);
    final ready = current >= safeRequired;
    final valueLabel = ready ? 'ready' : '$current/$safeRequired';
          ...
          children: [
            SizedBox(
              ...
              child: Text(
                ...
                maxLines: 1,
                overflow: TextOverflow.ellipsis,
                style: GoogleFonts.plusJakartaSans(fontSize: compact ? 10.5 : 11.5, color: EchoColors.textGhost),
              ),
            ),
            Expanded(
              child: ClipRRect(
  ...
  Widget _buildRadarChart(List<Map<String, dynamic>> topics) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        final size = constraints.maxWidth.clamp(210.0, 260.0);
        return Center(
          child: TweenAnimationBuilder<double>(
  ...
  Widget _buildTrainButton() {
    ...
    final blockedReason = summary['blocked_reason'] as String?;
    final dpoReady = (summary['dpo_ready_pairs'] as num?)?.toInt() ?? 0;
    final dpoRequired = (summary['dpo_required_pairs'] as num?)?.toInt() ?? 4;
    final ready = canStart || dataReady || untrained >= required || dpoReady >= dpoRequired;
    final dpoOnly = ready && untrained < required && dpoReady >= dpoRequired;
    final label = canStart
        ? (dpoOnly ? 'Apply Lessons' : 'Update Echo')
        : ready
        ? 'Home Brain needed'
        : '$untrained saved';
    ...
    return Column(
      ...
      children: [
        GestureDetector(
          onTapDown: canStart ? (_) => setState(() => _pressing = true) : null,
          onTapUp: (_) {
            setState(() => _pressing = false);
            if (canStart) _startTraining();
          },
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    canStart
                        ? (_pressing ? EchoColors.amber.withValues(alpha: 0.80) : EchoColors.amber.withValues(alpha: 0.95))
                        : EchoColors.bgSurface,
                    canStart ? (_pressing ? EchoColors.amberDark.withValues(alpha: 0.85) : EchoColors.amberDark) : EchoColors.bgSurface,
                  ],
                ),
                borderRadius: BorderRadius.circular(16),
                border: canStart ? null : Border.all(color: EchoColors.borderSubtle),
                boxShadow: [
                  if (canStart)
                    BoxShadow(
              ...
              child: Row(
                ...
                children: [
                  Icon(
                    ...
                    size: 20,
                    color: canStart ? const Color(0xFF0A0800) : EchoColors.textGhost,
                  ),
                  const SizedBox(width: 10),
                  Flexible(
                    child: Text(
        ...
        Text(
          canStart
              ? dpoOnly
                    ? '$dpoReady saved preference lessons'
                    : '$untrained moments saved + $dpoReady preference lessons'
              : ready
              ? blockedReason ?? 'Enough signal is saved. Start Home Brain to update Echo.'
              : 'Target: $required useful outcomes. Each useful turn can become a lesson.',
  ...
  // â”€â”€â”€ ACTIVE TRAINING STATE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  Widget _buildActiveTraining(bool isRunning, bool isComplete) {
    ...
    final completeSummary = leading != null
        ? 'Echo learned from $prefSignals helpful choices. $leading is the style helping most often.'
        : dpoReady > 0
        ? 'Echo learned from $prefSignals helpful choices and $dpoReady saved lessons.'
        : 'Echo learned your latest style. Run Practice Versions to add stronger lessons.';
            ...
            Row(
              ...
              children: [
                Container(
                  ...
                  child: Icon(Icons.check_rounded, size: 14, color: EchoColors.amber),
                ),
                const SizedBox(width: 12),
                Text(
                  'Model updated',
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 10),
                      Text(
                        'What changed in Echo',
                        style: GoogleFonts.plusJakartaSans(fontSize: 13.5, fontWeight: FontWeight.w800, color: EchoColors.amberText),
                      ),
                    ],
                  ),
                  const SizedBox(height: 8),
                  Text(
                    adapterLoaded ? 'Echo is updated and live. $completeSummary' : 'Update finished. Echo improved but is waiting to go live.',
                    style: GoogleFonts.plusJakartaSans(fontSize: 13.2, color: EchoColors.amberText, height: 1.45),
                  ),
                ],
              ),
            ),
  ...
  Widget _pill(String text, {IconData? icon, Color? color}) {
    return Container(
      ...
      child: Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          if (icon != null) ...[Icon(icon, size: 14, color: color ?? EchoColors.textGhost), SizedBox(width: 6)],
          Text(
            text,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    void drawLabel(String text, Offset point, bool right) {
      final tp = TextPainter(
        text: TextSpan(
          text: text,
          style: TextStyle(fontSize: 9.0, color: EchoColors.amberText, fontFamily: 'PlusJakartaSans', fontWeight: FontWeight.w700),
        ),
        textDirection: TextDirection.ltr,
      )..layout();
