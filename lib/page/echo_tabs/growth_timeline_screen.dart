...
class _GrowthTimelineScreenState extends State<GrowthTimelineScreen> {
  ...
  Widget build(BuildContext context) {
    final milestones = (_data?['milestones'] as List? ?? [])
        .whereType<Map>()
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: _loading
            ? const Center(child: CircularProgressIndicator(color: EchoColors.amber))
            : ListView(
                ...
                children: [
                  ...
                  if (milestones.isEmpty)
                    ...
                    ...milestones.reversed.map(_timelineItem),
                ],
              ),
      ),
    );
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(title,
                      style: GoogleFonts.plusJakartaSans(
                          fontSize: 14, fontWeight: FontWeight.w800, color: EchoColors.textPrimary)),
                  if (summary.isNotEmpty) ...[
                    const SizedBox(height: 6),
                    Text(summary,
                        style: GoogleFonts.plusJakartaSans(
                            fontSize: 12.5, height: 1.45, color: EchoColors.textMuted)),
                  ],
                  if (date.isNotEmpty) ...[
