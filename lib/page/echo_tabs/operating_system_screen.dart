...
class _OperatingSystemScreenState extends State<OperatingSystemScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      final resp = await http
          .get(Uri.parse('${AuthService().baseUrl}/v1/user/rules'), headers: AuthService().authHeaders)
  ...
  Future<void> _showAddRuleDialog() async {
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: Text(
          'Add a rule',
          style: GoogleFonts.plusJakartaSans(fontSize: 15, fontWeight: FontWeight.w600, color: EchoColors.textPrimary),
        ),
        content: Column(
        ...
        actions: [
          ...
          TextButton(
            ...
            child: Text(
              'Add',
              style: GoogleFonts.plusJakartaSans(color: EchoColors.amber, fontWeight: FontWeight.w600),
            ),
          ),
        ],
      ),
  ...
  Future<void> _deleteRule(int ruleId) async {
    try {
      await http
          .delete(Uri.parse('${AuthService().baseUrl}/v1/user/rules/$ruleId'), headers: AuthService().authHeaders)
          .timeout(const Duration(seconds: 10));
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style: GoogleFonts.plusJakartaSans(fontSize: 11.5, color: EchoColors.textGhost, height: 1.6),
              ),
            ),
            // Rules list
            Expanded(
              child: _loading
                  ...
                  ? Center(
                      child: Padding(
                        ...
                        child: Text(
                          'No rules distilled yet.\nEcho is still building your rules.',
                      ...
                      child: ListView(
                        ...
                        children: [
                          ..._rules.asMap().entries.map(
                            (e) => _RuleItem(index: e.key, rule: e.value, onDelete: () => _deleteRule(e.value['id'] as int)),
                          ),
                          const SizedBox(height: 12),
                          Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border(left: BorderSide(color: EchoColors.amber.withValues(alpha: 0.4), width: 2)),
                            ),
                            child: RichText(
                              text: TextSpan(
                                style: GoogleFonts.plusJakartaSans(fontSize: 11.5, color: EchoColors.textMuted, height: 1.6),
                                children: [
                                  TextSpan(text: 'Echo learned these from how you '),
                                  TextSpan(
                                    text: 'actually live',
                                    style: TextStyle(color: EchoColors.amber, fontWeight: FontWeight.w500),
                                  ),
...
class _RuleItem extends StatelessWidget {
  ...
  static final _lineColors = [EchoColors.amber, Color(0xFF9A6AB4)];
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(gradient: LinearGradient(colors: [lineColor.withValues(alpha: 0.4), Colors.transparent])),
                  ),
                  Text(
                    text,
                    style: isHighConf
                        ...
                        : GoogleFonts.plusJakartaSans(fontSize: 13.5, color: EchoColors.textSecondary, height: 1.6),
                  ),
