...
class _TwinScreenState extends State<TwinScreen> with SingleTickerProviderStateMixin {
  ...
  bool _chosePersonalAnswer = false;
  ...
  Future<void> _choose(String choice) async {
    ...
    if (!mounted) return;
    await _transition(() {
      _chosePersonalAnswer = result?['chose_clone'] as bool? ?? false;
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Your choice becomes a lesson about what kind of guidance fits you.',
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Center(
                child: Text(
                  'Compare answers',
                  style: GoogleFonts.plusJakartaSans(fontSize: 15, fontWeight: FontWeight.w600, color: EchoColors.bg),
                ),
              ),
            ),
          ),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                Text(
                  _chosePersonalAnswer
                      ? 'You picked the personalized answer. Echo is learning what actually fits.'
                      : 'You picked the general answer. Echo needs more outcomes for this kind of situation.',
