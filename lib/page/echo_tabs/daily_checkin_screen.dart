...
class _DailyCheckinScreenState extends State<DailyCheckinScreen> with TickerProviderStateMixin {
  ...
  static const _staticEchoes = ['Got it. I\'m tracking that.', 'Honest. That matters.', 'That\'s the one I was looking for.'];
  ...
  String get _currentEcho => _qIndex < _staticEchoes.length ? _staticEchoes[_qIndex] : 'Got it.';
  ...
  void initState() {
    ...
    _slideAnim = Tween<Offset>(begin: const Offset(0, 0.08), end: Offset.zero).animate(CurvedAnimation(parent: _slideCtrl, curve: Curves.easeOut));
  ...
  Future<void> _finishCheckin() async {
    final qas = List.generate(_questions.length, (i) => {'q': _questions[i], 'a': i < _answers.length ? _answers[i] : ''});
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Outcome saved.',
              style: GoogleFonts.lora(color: EchoColors.textPrimary, fontSize: 20, fontStyle: FontStyle.italic, height: 1.5),
            ),
            const SizedBox(height: 32),
            GestureDetector(
              onTap: () => Navigator.of(context).pop(),
              child: Text('Close', style: GoogleFonts.plusJakartaSans(color: EchoColors.textGhost, fontSize: 13, letterSpacing: 0.3)),
            ),
          ],
        ),
      ),
        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                'Daily Outcome',
                style: GoogleFonts.lora(fontSize: 24, fontStyle: FontStyle.italic, color: EchoColors.textPrimary, letterSpacing: -0.3),
              ),
              const SizedBox(height: 8),
              Text('3 questions - 1 minute', style: GoogleFonts.plusJakartaSans(fontSize: 12, color: EchoColors.textGhost)),
              const SizedBox(height: 14),
              Text(
                'Save what happened so Today, You, and Echo can improve.',
                style: GoogleFonts.lora(fontSize: 13, fontStyle: FontStyle.italic, color: EchoColors.textGhost),
              ),
  ...
  // â”€â”€â”€ Main flow â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  Widget _buildFlow() {
    ...
    return Column(
      children: [
        ...
        _buildOrb(),
        const SizedBox(height: 28),
        Padding(padding: const EdgeInsets.symmetric(horizontal: 30), child: _phase == _Phase.echoing ? _buildEchoSynthesis() : _buildQuestion()),
        const Spacer(),
      ...
      child: Row(
        children: [
          GestureDetector(
            ...
            child: Icon(Icons.close, size: 18, color: EchoColors.textVeryGhost),
          ),
          const Spacer(),
          // Progress dots
          Row(
  ...
  Widget _buildOrb() {
    return Padding(
      ...
      child: Center(
        child: EchoOrb(size: _phase == _Phase.echoing ? 64 : 52, rings: _phase == _Phase.echoing ? 3 : 2),
      ),
    );
  }
  ...
  Widget _buildQuestion() {
    return Text(
      ...
      style: GoogleFonts.lora(fontSize: 20, fontStyle: FontStyle.italic, height: 1.58, color: EchoColors.textPrimary, letterSpacing: -0.2),
    );
  }
    ...
    return Column(
      children: [
        ...
        Text(
          _currentEcho,
          textAlign: TextAlign.center,
          style: GoogleFonts.lora(fontSize: 20, fontStyle: FontStyle.italic, height: 1.55, color: EchoColors.textMuted, letterSpacing: -0.2),
        ),
        if (_answers.isNotEmpty) ...[
          ...
          Container(
            ...
            child: Text(
              '"${_answers.last}"',
              textAlign: TextAlign.center,
              style: GoogleFonts.plusJakartaSans(fontSize: 12.5, height: 1.6, color: EchoColors.textGhost),
              maxLines: 4,
        ...
        child: Container(
          ...
          child: Center(
            child: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.edit_rounded, size: 14, color: EchoColors.textGhost),
                const SizedBox(width: 8),
                Text('tap to answer', style: GoogleFonts.plusJakartaSans(fontSize: 13, color: EchoColors.textGhost)),
              ],
            ),
          ),
        ),
  ...
  Widget _buildTextInput() {
    return Padding(
      padding: EdgeInsets.fromLTRB(20, 0, 20, MediaQuery.of(context).viewInsets.bottom > 0 ? 8 : 0),
      child: Row(
        ...
        children: [
          Expanded(
            child: TextField(
              ...
              style: GoogleFonts.plusJakartaSans(fontSize: 14, color: EchoColors.textPrimary, height: 1.5),
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              height: 46,
              decoration: BoxDecoration(shape: BoxShape.circle, color: EchoColors.amber),
              child: Icon(Icons.arrow_forward_rounded, color: EchoColors.bg, size: 18),
            ),
          ),
        ],
      ),
