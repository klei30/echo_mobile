...
class _TalentScreenState extends State<TalentScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: _loading ? _buildLoading() : _error ? _buildError() : _buildContent(),
      ),
    );
  }
  ...
  Widget _buildRevealIntro() {
    return Column(
      ...
      children: [
        ...
        Text(
          'I\'ve been watching how you think.',
          style: GoogleFonts.lora(
            fontSize: 19, fontStyle: FontStyle.italic,
            height: 1.5, color: EchoColors.textPrimary,
          ),
        ),
        ...
        Text(
          ...
          style: GoogleFonts.lora(
            fontSize: 19, fontStyle: FontStyle.italic,
            height: 1.5, color: EchoColors.amberText,
          ),
        ),
      ],
    );
  ...
  Widget _buildEvidence(List<String> evidence) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        ...evidence.asMap().entries.map((e) => Padding(
